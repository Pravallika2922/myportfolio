...
export const stats = [
...

  {
    id: 4,
    no: '2+',
    title: ' Teaching experience <br/> Restarting my career after maternity break',
  },
];
...
export const resume = [
...

  {
    ...
    year: '2009',
    title: 'BTech in ECE <span> SriNidhi Institute of Science & Technology </span>',
...
export const portfolio = [
  ...
  //   id: 1,
  //   img: Work9,
  //   title: 'Amazon Add to basket',
  //   details: [
  //     {
  //       icon: <FiFileText />,
  //       title: 'Project : ',
  //       desc: 'Amazon Add to basket',
  //     },
